...
export const sales_modelAPI: ObjectFields = {
  sales_order: schemaContructor.object({
  ...
  sales_saleOrderLine: schemaContructor.object({
  ...
  sales_customer: schemaContructor.object({
  ...
  sales_unit: schemaContructor.object({
    name: schemaContructor.string(),
  }),
};
